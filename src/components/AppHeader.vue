  ...
  <div>
    ...
    <header
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between">
        ...
        <!-- Logo and Slogan -->
        <motion.div class="flex items-center gap-2 md:gap-3" :initial="{ opacity: 0, x: -15 }" :animate="{ opacity: 1, x: 0 }"
          :transition="{ type: 'spring', stiffness: 300, damping: 20 }">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1080"
            class="w-8 h-8 md:w-10 md:h-10 object-contain drop-shadow-md text-blue-900 dark:text-white fill-current">
            <path
          ...
          <div>
            ...
            <p class="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 font-medium hidden sm:block">Philippine Government
        ...
        <div class="flex items-center gap-2 w-auto">
          ...
          <div ref="dropdownRef" class="relative flex items-center w-auto lg:hidden">
            <motion.button @click="isMenuOpen = !isMenuOpen" 
            ...
            <transition enter-active-class="transition duration-200 ease-out" enter-from-class="transform scale-95 opacity-0" enter-to-class="transform scale-100 opacity-100" leave-active-class="transition duration-75 ease-in" leave-from-class="transform scale-100 opacity-100" leave-to-class="transform scale-95 opacity-0">
              <div v-if="isMenuOpen" 
                ...
                <button @click="store.toggleLargeText(); isMenuOpen = false" 
                  ...
                  <Type class="w-4 h-4 text-slate-500" :class="store.isLargeText ? 'text-blue-600 dark:text-blue-400' : ''" />
                  <span class="text-sm font-medium text-slate-700 dark:text-slate-300" :class="store.isLargeText ? 'text-blue-600 dark:text-blue-400' : ''">
