...
<template>
  <div>
    ...
    <header
      class="sticky top-0 z-40 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 transition-colors">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">

        <!-- Logo and Slogan -->
        <motion.div class="flex items-center gap-3" :initial="{ opacity: 0, x: -15 }" :animate="{ opacity: 1, x: 0 }"
          :transition="{ type: 'spring', stiffness: 300, damping: 20 }">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1080"
            class="w-10 h-10 object-contain drop-shadow-md text-blue-900 dark:text-white fill-current">
            <path
