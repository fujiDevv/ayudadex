        ...
        >
          ...
          <div>
            <div class="flex items-center gap-1.5">
              <h1
                class="text-xl md:text-2xl font-bold tracking-tight text-blue-900 dark:text-white"
              >
                Ayuda
              </h1>
            </div>
            <p
              class="text-[10px] md:text-xs text-slate-500 dark:text-slate-400 font-medium hidden sm:block"
            >
              Philippine Government Social Benefits Navigator
            </p>
          </div>
        </motion.div>
        ...
        <div class="flex items-center gap-2 w-auto">
          ...
          <div class="hidden md:flex items-center">
            <div ref="navDropdownRef" class="relative">
              <motion.button
                @click="isNavDropdownOpen = !isNavDropdownOpen"
          ...
          <div ref="dropdownRef" class="relative flex items-center w-auto lg:hidden">
            <motion.button
              ...
              class="p-2 rounded-lg text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
              :class="
                isMenuOpen ? 'bg-slate-100 dark:bg-slate-800 text-blue-600 dark:text-blue-400' : ''
              "
              :whileHover="{ scale: 1.12 }"
              :whileTap="{ scale: 0.88 }"
            >
              ...
              >
                ...
                >
                  ...
                  <div class="relative flex items-center">
                    ...
                    <div
                      class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-1.5 text-slate-500"
                    >
                      <svg class="w-3 h-3 fill-current" viewBox="0 0 20 20">
                        <path
                          d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
    ...
    >
      <div class="grid grid-cols-6 h-16 text-center text-[10px] sm:text-xs font-bold">
        <motion.button
          ...
          :class="
            route.path === '/'
              ? 'text-blue-900 dark:text-blue-400 bg-blue-50/40 dark:bg-blue-950/20'
        ...
        >
          ...
          />
          <span class="hidden sm:block truncate w-full px-1"
            >{{ $t("nav.saved") }} ({{ savedCount }})</span
          >
        </motion.button>
        <motion.button
          @click="router.push('/hotlines')"
          class="flex flex-col items-center justify-center gap-0 sm:gap-1 cursor-pointer transition-colors"
          :class="
            route.path === '/hotlines'
              ? 'text-blue-900 dark:text-blue-400 bg-blue-50/40 dark:bg-blue-950/20'
