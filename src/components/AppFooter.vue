...
<template>
  <footer class="mt-20 border-t border-slate-200 dark:border-slate-800 pt-10 pb-8 text-xs text-slate-500 dark:text-slate-400">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="space-y-3">
          <div class="flex items-center gap-2">
            <div class="w-7 h-7 rounded-lg bg-blue-900 flex items-center justify-center text-white font-extrabold text-xs">
              AD
            </div>
          ...
          <p class="leading-relaxed text-slate-500 dark:text-slate-400">
            An open-source citizen initiative designed to simplify and track access to public welfare programs in the Philippines. Developed for informational guidance.
          </p>
        </div>

        <!-- Column 2: App Navigation Links -->
        <div class="space-y-3 md:pl-8">
          <span class="font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider text-[10px]">Navigation</span>
          <ul class="space-y-2">
        ...
        <div class="space-y-3">
          <span class="font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider text-[10px]">Resources</span>
          <ul class="space-y-2">
            ...
            <li class="pt-1">
              <a 
                href="https://github.com/joshuasarmiento/ayudadex" 
                target="_blank" 
      ...
      <!-- Disclaimer Box (Clean and Minimalist text) -->
