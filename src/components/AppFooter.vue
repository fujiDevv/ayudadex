      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="space-y-3">
          <div class="flex items-center gap-2">
            ...
            <span class="font-bold text-base text-slate-900 dark:text-slate-100 tracking-tight">{{ $t('header.title') }}</span>
          </div>
        ...
        <div class="space-y-3 md:pl-8">
          <span
            class="font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider text-[10px]">{{ $t('footer.navLabel') }}</span>
        ...
        <div class="space-y-3">
          <span
            class="font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider text-[10px]">{{ $t('footer.resourcesLabel') }}</span>
          <ul class="space-y-2 mt-3">
