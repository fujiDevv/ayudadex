...
import { AlertTriangle, Github, Heart, ArrowUpRight, Mail } from "lucide-vue-next";
...
<template>
  ...
  >
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
      ...
      <!-- Disclaimer Box -->
      <div
        class="space-y-1.5 text-[11px] leading-relaxed text-slate-600 dark:text-slate-400 italic"
      >
        <p
          class="flex items-center gap-1.5 font-semibold text-slate-700 dark:text-slate-300 not-italic"
        >
