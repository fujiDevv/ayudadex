...
const isSaved = computed(() =>
  program.value ? store.savedPrograms.includes(program.value.id) : false,
);
const checkedList = computed(() =>
  program.value ? store.checkedRequirements[program.value.id] || [] : [],
);
  ...
  <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-16 animate-fade-in">
    ...
    >
      ...
      <div class="flex items-center flex-wrap gap-1.5 mt-6">
        <span
          class="text-xs font-bold text-slate-600 dark:text-slate-300 uppercase tracking-wide mr-1"
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        ...
        >
          ...
          <div>
            ...
            <p class="text-base font-bold text-slate-900 dark:text-slate-100 mt-0.5">
          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              <p
                class="text-[10px] font-bold text-slate-600 dark:text-slate-300 uppercase tracking-wider"
              >
                {{ $t("detail.officialPortal") }}
              </p>
              <p class="text-base font-bold text-blue-900 dark:text-blue-400 mt-0.5">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div class="space-y-6">
          ...
          <div
            class="relative pl-6 border-l-2 border-slate-100 dark:border-slate-800 space-y-8 ml-2 mt-2"
          >
            <div
            ...
            >
              <span
                class="absolute -left-[33px] top-1 w-5 h-5 rounded-full bg-blue-900 dark:bg-blue-800 border-4 border-white dark:border-slate-900 flex items-center justify-center"
              ></span>
              <div class="space-y-1.5">
                <p
                  class="text-[10px] font-black text-blue-900 dark:text-blue-400 uppercase tracking-widest"
                >
                  Step {{ Number(idx) + 1 }}
                </p>
        ...
        >
          <div
            class="flex items-center justify-between border-b border-slate-200/60 dark:border-slate-800 pb-4"
          >
            <h4
            ...
            >
              {{ checkedList.length }} / {{ program.requirements.length }}
              {{ $t("detail.prepared") }}
            </span>
          </div>
      ...
      <div class="flex items-center justify-center">
        <motion.button
          @click="router.push({ path: '/contact', query: { program: program.id } })"
