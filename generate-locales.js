...
const tlOverrides = {
  "philhealth-yakap": {
    ...
    description:
      "Isang pinahusay na pakete ng benepisyo sa pangunahing pangangalaga (na pumapalit sa dating Konsulta Package) na nagbibigay ng holistic na pangangalagang pangkalusugan kabilang ang libreng konsultasyong medikal, pinalawak na laboratoryo at cancer screening tests, at mga pangunahing gamot.",
    steps: [
  ...
  "philhealth-newborn": {
    ...
    description:
      "Nagbibigay ng mga pangunahing serbisyong pangkalusugan para sa mga bagong silang na sanggol kabilang ang physical examination, eye prophylaxis, pagbibigay ng vitamin K, bakunang BCG, unang dosis ng bakuna sa hepatitis B, at newborn screening test.",
    steps: [
  ...
  "dole-tupad": {
    ...
    description:
      "Isang community-based na tulong na nagbibigay ng emergency employment para sa mga nawalan ng trabaho, underemployed, at seasonal workers, sa minimum na 10 araw hanggang 90 araw sa mga natatanging sitwasyon.",
    steps: [
  ...
  "sss-funeral": {
    ...
    description:
      "Isang benepisyong cash mula sa fixed na ₱12,000 (para sa 1-35 kontribusyon) hanggang ₱20,000 - ₱60,000 (para sa 36 o higit pang kontribusyon) na ibinibigay sa sinumang nagbayad ng gastusin sa pagpapalibing ng yumaong miyembro ng SSS.",
    steps: [
  ...
  "gsis-funeral": {
    name: "Benepisyo sa Pagpapalibing (Funeral Benefit)",
    description:
      "Isang benepisyong cash na nagkakahalaga ng ₱30,000 na ibinibigay sa nabubuhay na asawa, mga anak, o kung sino man ang nagbayad ng gastusin sa pagpapalibing ng yumaong miyembro o retirado ng GSIS.",
    steps: [
  ...
  "tesda-training": {
    ...
    description:
      "Nagbibigay ng libreng pagsasanay sa bokasyonal, assessment, at mga toolkit para sa pangkabuhayan sa ilalim ng mga programa tulad ng TWSP, STEP, at PESFA upang matulungan ang mga mamamayan na makahanap ng bagong trabaho.",
    steps: [
  ...
  "dswd-spisc": {
    ...
    description:
      "Isang buwanang allowance na ₱1,000 (ipinamamahagi bilang ₱3,000 quarterly) na ibinibigay sa mga mahihirap na senior citizen upang madagdagan ang kailangang pang-araw-araw na pagkain at medikal na gastusin.",
    steps: [
  ...
  "sss-retirement": {
    ...
    description:
      "Isang benepisyong cash na ibinibigay sa miyembro ng SSS na hindi na makapagtrabaho dahil sa katandaan, na ipinagkakaloob bilang panghabambuhay na buwanang pension o lump sum.",
    steps: [
  ...
  "ched-tes": {
    ...
    description:
      "Isang programa ng tulong-pinansyal na nagbibigay ng suporta sa mga kwalipikadong estudyanteng Pilipino na naka-enroll sa mga pampubliko at pribadong kolehiyo upang makatalong sa mga gastusin sa edukasyon.",
    steps: [
  ...
  "lgu-soloparent": {
    ...
    description:
      "Nagbibigay ng ipinag-uutos na pinansyal at panlipunang suporta sa mga solo parent, kabilang ang ₱1,000 buwanang subsidy para sa mga minimum wage earner, 10% discount sa mga pangunahing pangangailangan ng bata, at bayad na parental leave.",
    steps: [
